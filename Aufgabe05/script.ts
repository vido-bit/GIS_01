namespace Produkte {
    ...
    let lifestyleProdukte: Produkte[] = [shirt, cap, socken, spraydose, clipper, boxershorts, longsleeve, weihnachtspulli];
    let hygieneProdukte: Produkte[] = [desinfektionstuecher, haendeDesinfektion, mundNasenschutz, faceShield, abcmaske, zahnbuerste, schnelltest, schutzbrille, schutzanzug];
